...
object Day7Part2Test : Spek({
    describe("Day 7 Part 2") {
        it("should correctly compute exampe 1") {
            val program = "3,26,1001,26,-4,26,3,27,1002,27,2,27,1,27,26,27,4,27,1001,28,-1,28,1005,28,6,99,0,0,5"

            assertThat(part2(program)).isEqualTo(139629729)
        }

        it("should correctly compute exampe 2") {
            ...
            assertThat(part2(program)).isEqualTo(18216)
        }
    }
})